...
, SUM(CASE WHEN LENGTH(TRIM(PHONE_NUMBER))=0 OR PHONE_NUMBER IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PHONE_NUMBER
...
, SUM(CASE WHEN LENGTH(TRIM(START_DATETIME))=0 OR START_DATETIME IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_START_DATETIME
...
, SUM(CASE WHEN LENGTH(TRIM(END_DATETIME))=0 OR END_DATETIME IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_END_DATETIME
...
, SUM(CASE WHEN LENGTH(TRIM(SERVICE))=0 OR SERVICE IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_SERVICE
...
, SUM(CASE WHEN LENGTH(TRIM(FLG_TRANSFER))=0 OR FLG_TRANSFER IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_FLG_TRANSFER
