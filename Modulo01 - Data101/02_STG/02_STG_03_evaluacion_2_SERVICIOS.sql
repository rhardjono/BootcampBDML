...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_ID))=0 OR PRODUCT_ID IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_ID
...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_NAME))=0 OR PRODUCT_NAME IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_NAME
...
, SUM(CASE WHEN LENGTH(TRIM(ACCESS_POINT))=0 OR ACCESS_POINT IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_ACCESS_POINT
...
, SUM(CASE WHEN LENGTH(TRIM(CHANNEL))=0 OR CHANNEL IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_CHANNEL
...
, SUM(CASE WHEN LENGTH(TRIM(AGENT_CODE))=0 OR AGENT_CODE IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_AGENT_CODE
...
, SUM(CASE WHEN LENGTH(TRIM(INSTALL_DATE))=0 OR INSTALL_DATE IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_INSTALL_DATE
...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_CITY))=0 OR PRODUCT_CITY IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_CITY
...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_ADDRESS))=0 OR PRODUCT_ADDRESS IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_ADDRESS
...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_POSTAL_CODE))=0 OR PRODUCT_POSTAL_CODE IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_POSTAL_CODE
...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_STATE))=0 OR PRODUCT_STATE IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_STATE
...
, SUM(CASE WHEN LENGTH(TRIM(PRODUCT_COUNTRY))=0 OR PRODUCT_COUNTRY IS NULL THEN 1 ELSE 0 END) TOTAL_NULOSVACIOS_PRODUCT_COUNTRY
